...
app.get('/api/orders', (_req, res) => {
  try {
    ...
    res.json(orders.map(o => ({
      order_id: o.id, truv_order_id: o.truv_order_id, status: o.status,
      bridge_token: o.bridge_token, created_at: o.created_at,
...
app.post('/api/orders', async (req, res) => {
  try {
    ...
    db.createOrder({
      ...
      demoId: 'follow-up', bridgeToken: truvData.bridge_token,
