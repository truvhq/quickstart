...
const validProductTypes = ["employment", "income", "admin-directory", "admin-report", "fas", "deposit_switch"]

if (validProductTypes.indexOf(API_PRODUCT_TYPE) < 0) {
  console.error(
    "Not a Valid Product Type. Please specify an API_PRODUCT_TYPE of the following:"
  )
